...
function ShortenLinkCopyBtn(props: PropTypes) {
  return (
    ...
    >
      <button className='w-full transition border active:scale-95 rounded-xl bg-black/10 backdrop-opacity-40 backdrop-blur-3xl backdrop-brightness-200 border-cool-grey/20'>
